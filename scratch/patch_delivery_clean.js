...
// Replace all occurrences of Bolt Food dropdown option with Bolt Food + Tabaruq Delivery
...
// Fix the exact indentation for specific dropdowns to look nice (optional but safe since they are functionally identical)

html = html.replaceAll('<option value="Bolt Food">Bolt Food Only</option>', '<option value="Bolt Food">Bolt Food Only</option>\n                                <option value="Tabaruq Delivery">Tabaruq Delivery Only</option>');
...
const pricesReplacement = `<div class="form-group" id="diBoltPriceGroup">
                                ...
                                <div class="form-group" id="diOwnDeliveryPriceGroup">
                                    <label style="font-size:0.7rem;">Tabaruq Delivery Price</label>
...
const toggleLogic = `const boltGrp = document.getElementById('diBoltPriceGroup');
            ...
            if (platform === 'Uber Eats') {
                ...
                glovoInput.disabled = true;
                ownInput.disabled = true;
            } else if (platform === 'Tabaruq Delivery') {
                uberGrp.style.opacity = '0.3';
                glovoGrp.style.opacity = '0.3';
                boltGrp.style.opacity = '0.3';
                uberInput.disabled = true;
...
console.log('delivery.html successfully patched from scratch with Tabaruq Delivery.');
